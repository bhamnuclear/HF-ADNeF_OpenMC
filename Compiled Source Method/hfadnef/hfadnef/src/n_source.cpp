...
std::string FilePath = "/home/ADF/mjc970/Documents/High Flux Neutron Source/Python Module/hfadnef/" + std::to_string(gr)  + "/" + utilisateur + ".txt";
...
public:
  ...
  openmc::SourceSite sample(uint64_t* seed) const
  {
    ...
    particle.wgt = 1.0; // linInterp(yield_E, yield_N, Ep_);
