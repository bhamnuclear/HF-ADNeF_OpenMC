...
private:
  ...
  void loadData() {
    ...
    std::ifstream file3(FilePath + "/src/XS_ang0_new.txt");
    if (!file3.is_open()) {
      // Handle file opening error
      throw std::runtime_error("Failed to open file: XS_ang0_new.txt");
    }
    ...
    std::ifstream file4(FilePath + "/src/XS_ang1_new.txt");
    if (!file4.is_open()) {
      // Handle file opening error
      throw std::runtime_error("Failed to open file: XS_ang1_new.txt");
    }
